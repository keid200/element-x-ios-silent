...
final nonisolated class AppSettings: @unchecked Sendable {
    ...
    let backgroundAppRefreshTaskIdentifier = "com.cybershield.silent.background.refresh"
    
    /// A URL where users can go read more about the app.
    private(set) var websiteURL: URL = "https://cybershieldits.com"
    /// A URL that contains the app's logo that may be used when showing content in a web view.
    private(set) var logoURL: URL = "https://cybershieldits.com/favicon.ico"
    /// A URL that contains that app's copyright notice.
    private(set) var copyrightURL: URL = "https://cybershieldits.com"
    /// A URL that contains the app's Terms of use.
    private(set) var acceptableUseURL: URL = "https://cybershieldits.com"
    /// A URL that contains the app's Privacy Policy.
    private(set) var privacyURL: URL = "https://cybershieldits.com"
    /// A URL where users can go read more about encryption in general.
    private(set) var encryptionURL: URL = "https://cybershieldits.com"
    /// A URL where users can go read more about device verification..
    private(set) var deviceVerificationURL: URL = "https://cybershieldits.com"
    /// A URL where users can go read more about the chat backup.
    private(set) var chatBackupDetailsURL: URL = "https://cybershieldits.com"
    /// A URL where users can go read more about identity pinning violations
    private(set) var identityPinningViolationDetailsURL: URL = "https://cybershieldits.com"
    /// A URL describing how history sharing works
    private(set) var historySharingDetailsURL: URL = "https://cybershieldits.com"
    
    /// Any domains that Element web may be hosted on - used for handling links.
    private(set) var elementWebHosts = ["matrix.cybershieldits.com"]
    /// The domain that account provisioning links will be hosted on - used for handling the links.
    private(set) var accountProvisioningHost = "matrix.cybershieldits.com"
    ...
    private(set) var pushGatewayBaseURL: URL = "https://push.cybershieldits.com"
